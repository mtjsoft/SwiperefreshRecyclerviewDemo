...
import com.example.swiperefreshrecyclerview.HHBaseListRecyclerViewActivity;
...
public class ListActivityDemo extends HHBaseListRecyclerViewActivity<DataModel> {
    ...
    protected HHBaseRecyclerViewAdapter<DataModel> instanceAdapter(List<DataModel> list) {
        return new MyAdapterDemo(getBaseContext(), list);
    }
